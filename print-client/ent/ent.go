...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			localdevice.Table:      localdevice.ValidColumn,
			logerror.Table:         logerror.ValidColumn,
			printjob.Table:         printjob.ValidColumn,
			recentscan.Table:       recentscan.ValidColumn,
			remoteconnection.Table: remoteconnection.ValidColumn,
			uniquecomputer.Table:   uniquecomputer.ValidColumn,
		})
	})
