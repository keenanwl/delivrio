...
const (
	// Label holds the string label denoting the carrierdsv type in the database.
	Label = "carrier_dsv"
	...
	EdgeCarrier = "carrier"
	// Table holds the table name of the carrierdsv in the database.
	Table = "carrier_ds_vs"
	// TenantTable is the table that holds the tenant relation/edge.
	TenantTable = "carrier_ds_vs"
	...
	CarrierColumn = "carrier_carrier_dsv"
)

// Columns holds all SQL columns for carrierdsv fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
}

// ForeignKeys holds the SQL foreign-keys that are owned by the "carrier_ds_vs"
...
// OrderOption defines the ordering options for the CarrierDSV queries.
