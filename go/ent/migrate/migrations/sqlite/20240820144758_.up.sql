...
CREATE TABLE `new_printers` (`id` text NOT NULL, `device_id` text NOT NULL, `name` text NOT NULL, `label_zpl` bool NOT NULL DEFAULT (false), `label_pdf` bool NOT NULL DEFAULT (false), `label_png` bool NOT NULL DEFAULT (false), `document` bool NOT NULL DEFAULT (false), `rotate_180` bool NOT NULL DEFAULT (false), `print_size` text NOT NULL DEFAULT ('A4'), `created_at` datetime NOT NULL, `last_ping` datetime NOT NULL, `tenant_id` text NOT NULL, `workstation_printer` text NOT NULL, PRIMARY KEY (`id`), CONSTRAINT `printers_tenants_tenant` FOREIGN KEY (`tenant_id`) REFERENCES `tenants` (`id`) ON DELETE NO ACTION, CONSTRAINT `printers_workstations_printer` FOREIGN KEY (`workstation_printer`) REFERENCES `workstations` (`id`) ON DELETE NO ACTION);
-- Copy rows from old table "printers" to new temporary table "new_printers"
INSERT INTO `new_printers` (`id`, `device_id`, `name`, `label_zpl`, `label_pdf`, `document`, `rotate_180`, `print_size`, `created_at`, `last_ping`, `tenant_id`, `workstation_printer`) SELECT `id`, `device_id`, `name`, `label_zpl`, `label_pdf`, `document`, `rotate_180`, `print_size`, `created_at`, `last_ping`, `tenant_id`, `workstation_printer` FROM `printers`;
