...
const (
	// Label holds the string label denoting the returncollihistory type in the database.
	Label = "return_colli_history"
	...
	// Table holds the table name of the returncollihistory in the database.
	Table = "return_colli_histories"
	// ChangeHistoryTable is the table that holds the change_history relation/edge.
	ChangeHistoryTable = "return_colli_histories"
	...
	ChangeHistoryColumn = "change_history_return_colli_history"
	// TenantTable is the table that holds the tenant relation/edge.
	TenantTable = "return_colli_histories"
	...
	ReturnColliTable = "return_colli_histories"
	...
	ReturnColliColumn = "return_colli_return_colli_history"
)

// Columns holds all SQL columns for returncollihistory fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldDescription,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "return_colli_histories"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"change_history_return_colli_history",
	"return_colli_return_colli_history",
}
...
func TypeValidator(_type Type) error {
	...
	case TypeCreate, TypeUpdate, TypeDelete, TypeNotify:
		return nil
	default:
		return fmt.Errorf("returncollihistory: invalid enum value for type field: %q", _type)
	}
}

// OrderOption defines the ordering options for the ReturnColliHistory queries.
