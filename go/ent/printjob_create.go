...
func (pjc *PrintJobCreate) SetTenantID(pu pulid.ID) *PrintJobCreate {
	pjc.mutation.SetTenantID(pu)
	return pjc
}
...
func (pjc *PrintJobCreate) SetDocumentType(pt printjob.DocumentType) *PrintJobCreate {
	pjc.mutation.SetDocumentType(pt)
	return pjc
}

// SetPrinterMessages sets the "printer_messages" field.
func (pjc *PrintJobCreate) SetPrinterMessages(s []string) *PrintJobCreate {
	pjc.mutation.SetPrinterMessages(s)
	return pjc
}
...
func (pjc *PrintJobCreate) SetTenant(t *Tenant) *PrintJobCreate {
	return pjc.SetTenantID(t.ID)
}

// SetPrinterID sets the "printer" edge to the Printer entity by ID.
func (pjc *PrintJobCreate) SetPrinterID(id pulid.ID) *PrintJobCreate {
	pjc.mutation.SetPrinterID(id)
	return pjc
}

// SetPrinter sets the "printer" edge to the Printer entity.
func (pjc *PrintJobCreate) SetPrinter(p *Printer) *PrintJobCreate {
	return pjc.SetPrinterID(p.ID)
}

// SetColliID sets the "colli" edge to the Colli entity by ID.
func (pjc *PrintJobCreate) SetColliID(id pulid.ID) *PrintJobCreate {
	pjc.mutation.SetColliID(id)
	return pjc
}

// SetNillableColliID sets the "colli" edge to the Colli entity by ID if the given value is not nil.
func (pjc *PrintJobCreate) SetNillableColliID(id *pulid.ID) *PrintJobCreate {
	if id != nil {
		pjc = pjc.SetColliID(*id)
	}
	return pjc
}

// SetColli sets the "colli" edge to the Colli entity.
func (pjc *PrintJobCreate) SetColli(c *Colli) *PrintJobCreate {
	return pjc.SetColliID(c.ID)
}

// SetShipmentParcelID sets the "shipment_parcel" edge to the ShipmentParcel entity by ID.
func (pjc *PrintJobCreate) SetShipmentParcelID(id pulid.ID) *PrintJobCreate {
	pjc.mutation.SetShipmentParcelID(id)
	return pjc
}
...
func (pjc *PrintJobCreate) SetNillableShipmentParcelID(id *pulid.ID) *PrintJobCreate {
	if id != nil {
		pjc = pjc.SetShipmentParcelID(*id)
	}
	return pjc
}

// SetShipmentParcel sets the "shipment_parcel" edge to the ShipmentParcel entity.
func (pjc *PrintJobCreate) SetShipmentParcel(s *ShipmentParcel) *PrintJobCreate {
	return pjc.SetShipmentParcelID(s.ID)
}
...
func (pjc *PrintJobCreate) defaults() error {
	if _, ok := pjc.mutation.CreatedAt(); !ok {
		if printjob.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized printjob.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := printjob.DefaultCreatedAt()
		pjc.mutation.SetCreatedAt(v)
	}
	if _, ok := pjc.mutation.ID(); !ok {
		if printjob.DefaultID == nil {
			return fmt.Errorf("ent: uninitialized printjob.DefaultID (forgotten import ent/runtime?)")
		}
...
func (pjc *PrintJobCreate) check() error {
	if _, ok := pjc.mutation.TenantID(); !ok {
	...
	if _, ok := pjc.mutation.DocumentType(); !ok {
		return &ValidationError{Name: "document_type", err: errors.New(`ent: missing required field "PrintJob.document_type"`)}
	}
	if v, ok := pjc.mutation.DocumentType(); ok {
		if err := printjob.DocumentTypeValidator(v); err != nil {
			return &ValidationError{Name: "document_type", err: fmt.Errorf(`ent: validator failed for field "PrintJob.document_type": %w`, err)}
		}
	}
	...
	if len(pjc.mutation.TenantIDs()) == 0 {
		return &ValidationError{Name: "tenant", err: errors.New(`ent: missing required edge "PrintJob.tenant"`)}
	}
	if len(pjc.mutation.PrinterIDs()) == 0 {
		return &ValidationError{Name: "printer", err: errors.New(`ent: missing required edge "PrintJob.printer"`)}
	}
	return nil
}
...
func (pjc *PrintJobCreate) createSpec() (*PrintJob, *sqlgraph.CreateSpec) {
	...
	if value, ok := pjc.mutation.DocumentType(); ok {
		_spec.SetField(printjob.FieldDocumentType, field.TypeEnum, value)
		_node.DocumentType = value
	}
	if value, ok := pjc.mutation.PrinterMessages(); ok {
		_spec.SetField(printjob.FieldPrinterMessages, field.TypeJSON, value)
		_node.PrinterMessages = value
	}
	...
	if nodes := pjc.mutation.TenantIDs(); len(nodes) > 0 {
	...
	if nodes := pjc.mutation.PrinterIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
		...
		_node.print_job_printer = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	if nodes := pjc.mutation.ColliIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
		...
		_node.print_job_colli = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	if nodes := pjc.mutation.ShipmentParcelIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
		...
		_node.print_job_shipment_parcel = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	return _node, _spec
}
...
// SetTenantID sets the "tenant_id" field.
func (u *PrintJobUpsert) SetTenantID(v pulid.ID) *PrintJobUpsert {
...
// SetPrinterMessages sets the "printer_messages" field.
func (u *PrintJobUpsert) SetPrinterMessages(v []string) *PrintJobUpsert {
	u.Set(printjob.FieldPrinterMessages, v)
	return u
}

// UpdatePrinterMessages sets the "printer_messages" field to the value that was provided on create.
func (u *PrintJobUpsert) UpdatePrinterMessages() *PrintJobUpsert {
	u.SetExcluded(printjob.FieldPrinterMessages)
	return u
}

// ClearPrinterMessages clears the value of the "printer_messages" field.
func (u *PrintJobUpsert) ClearPrinterMessages() *PrintJobUpsert {
	u.SetNull(printjob.FieldPrinterMessages)
	return u
}
...
func (u *PrintJobUpsertOne) UpdateNewValues() *PrintJobUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		...
		if _, exists := u.create.mutation.DocumentType(); exists {
			s.SetIgnore(printjob.FieldDocumentType)
		}
...
// SetTenantID sets the "tenant_id" field.
func (u *PrintJobUpsertOne) SetTenantID(v pulid.ID) *PrintJobUpsertOne {
...
// SetPrinterMessages sets the "printer_messages" field.
func (u *PrintJobUpsertOne) SetPrinterMessages(v []string) *PrintJobUpsertOne {
	return u.Update(func(s *PrintJobUpsert) {
		s.SetPrinterMessages(v)
	})
}

// UpdatePrinterMessages sets the "printer_messages" field to the value that was provided on create.
func (u *PrintJobUpsertOne) UpdatePrinterMessages() *PrintJobUpsertOne {
	return u.Update(func(s *PrintJobUpsert) {
		s.UpdatePrinterMessages()
	})
}

// ClearPrinterMessages clears the value of the "printer_messages" field.
func (u *PrintJobUpsertOne) ClearPrinterMessages() *PrintJobUpsertOne {
	return u.Update(func(s *PrintJobUpsert) {
		s.ClearPrinterMessages()
	})
}
...
// SetTenantID sets the "tenant_id" field.
func (u *PrintJobUpsertBulk) SetTenantID(v pulid.ID) *PrintJobUpsertBulk {
	return u.Update(func(s *PrintJobUpsert) {
		s.SetTenantID(v)
	})
}
...
// SetPrinterMessages sets the "printer_messages" field.
func (u *PrintJobUpsertBulk) SetPrinterMessages(v []string) *PrintJobUpsertBulk {
	return u.Update(func(s *PrintJobUpsert) {
		s.SetPrinterMessages(v)
	})
}
...
// UpdatePrinterMessages sets the "printer_messages" field to the value that was provided on create.
func (u *PrintJobUpsertBulk) UpdatePrinterMessages() *PrintJobUpsertBulk {
	return u.Update(func(s *PrintJobUpsert) {
		s.UpdatePrinterMessages()
	})
}
...
// ClearPrinterMessages clears the value of the "printer_messages" field.
func (u *PrintJobUpsertBulk) ClearPrinterMessages() *PrintJobUpsertBulk {
	return u.Update(func(s *PrintJobUpsert) {
		s.ClearPrinterMessages()
	})
}
