...
const (
	// Label holds the string label denoting the shipmentdsv type in the database.
	Label = "shipment_dsv"
	...
	// Table holds the table name of the shipmentdsv in the database.
	Table = "shipment_ds_vs"
	// TenantTable is the table that holds the tenant relation/edge.
	TenantTable = "shipment_ds_vs"
	...
	ShipmentColumn = "shipment_shipment_dsv"
)

// Columns holds all SQL columns for shipmentdsv fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldBarcodeID,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "shipment_ds_vs"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"shipment_shipment_dsv",
}
...
// OrderOption defines the ordering options for the ShipmentDSV queries.
