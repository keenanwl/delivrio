...
const (
	...
	ChangeHistoryTable = "shipment_histories"
	...
	ChangeHistoryColumn = "change_history_shipment_history"
	// TenantTable is the table that holds the tenant relation/edge.
	TenantTable = "shipment_histories"
	...
	ShipmentColumn = "shipment_shipment_history"
)
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "shipment_histories"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"change_history_shipment_history",
	"shipment_shipment_history",
}
...
func TypeValidator(_type Type) error {
	...
	case TypeCreate, TypeUpdate, TypeDelete:
		return nil
	default:
		return fmt.Errorf("shipmenthistory: invalid enum value for type field: %q", _type)
	}
}
