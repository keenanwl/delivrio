...
const (
	// Label holds the string label denoting the shipmenteasypost type in the database.
	Label = "shipment_easy_post"
	...
	// FieldEpShipmentID holds the string denoting the ep_shipment_id field in the database.
	FieldEpShipmentID = "ep_shipment_id"
	// FieldRate holds the string denoting the rate field in the database.
	FieldRate = "rate"
	// FieldEstDeliveryDate holds the string denoting the est_delivery_date field in the database.
	FieldEstDeliveryDate = "est_delivery_date"
	// EdgeTenant holds the string denoting the tenant edge name in mutations.
	EdgeTenant = "tenant"
	// EdgeShipment holds the string denoting the shipment edge name in mutations.
	EdgeShipment = "shipment"
	// Table holds the table name of the shipmenteasypost in the database.
	Table = "shipment_easy_posts"
	// TenantTable is the table that holds the tenant relation/edge.
	TenantTable = "shipment_easy_posts"
	...
	ShipmentTable = "shipment_easy_posts"
	...
	ShipmentColumn = "shipment_shipment_easy_post"
)

// Columns holds all SQL columns for shipmenteasypost fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldTrackingNumber,
	FieldEpShipmentID,
	FieldRate,
	FieldEstDeliveryDate,
}

// ForeignKeys holds the SQL foreign-keys that are owned by the "shipment_easy_posts"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"shipment_shipment_easy_post",
}
...
// OrderOption defines the ordering options for the ShipmentEasyPost queries.
...
// ByEpShipmentID orders the results by the ep_shipment_id field.
func ByEpShipmentID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldEpShipmentID, opts...).ToFunc()
}
...
// ByEstDeliveryDate orders the results by the est_delivery_date field.
func ByEstDeliveryDate(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldEstDeliveryDate, opts...).ToFunc()
}
